  ...
  return (
    <header className="flex absolute flex-row items-center justify-between px-4 py-2 w-screen h-16 bg-custom-color">
      ...
      <nav className="flex space-x-4">
        <a className="text-white text-xl px-4 font-custom">Adidas-X</a>
        <a className="text-white text-xl px-4 font-custom">Predator</a>
        <a className="text-white text-xl px-4 font-custom">Copa</a>
      </nav>
