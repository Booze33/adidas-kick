...
import image from '../../assets/images/pogba.png';

const Pogba = () => {
  return (
    <div className='ml-6 img w-51 h-69'>
      <div className="rounded-full bg-eight w-3 h-1 ml-4"/>
      <img src={image} alt="Description" className="w-pogba h-pogba mt-63 " />
      <div className="w-3 h-69 ml-7 mt-71 flex flex-col justify-around">
        <h2 className="font-custom2 text-sky-400 text-3xl ml-8 mt-80">Predator-Freak POGBA</h2>
