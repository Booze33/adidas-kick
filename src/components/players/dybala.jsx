...
import image from '../../assets/images/dybala.png';

const Dybala = () => {
  return (
    <div className='ml-6 img w-51 h-69'>
      <div className="rounded-full bg-ninth w-3 h-1 ml-4"/>
      ...
      <div className="w-3 h-69 ml-7 mt-71 flex flex-col justify-around">
        <h2 className="font-custom2 text-sky-400 text-3xl ml-10 mt-80">Copa-Pure DYBALA</h2>
